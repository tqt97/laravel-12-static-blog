<x-app-layout>
    <x-slot name="toc">
        <aside
            class="max-w-[300px] min-w-[200px] hidden xl:block fixed right-0 xl:right-40 top-1/4 max-h-[30rem] overflow-y-auto bg-white border border-gray-200 shadow rounded p-4">
    ...
    <div class="max-w-5xl mx-auto w-full">
        {{-- TOC mobile --}}
        <div class="xl:hidden mb-2 rounded-md">
            <details class="bg-white rounded-md">
                <summary class="p-2 cursor-pointer font-semibold bg-gray-50 border-b">Table of contents</summary>
                    ...
                    <div class="flex w-1/2 justify-start items-center">
                        @if ($previous)
                            <a href="{{ route('articles.show', $previous->slug) }}"
                                class="group flex items-center bg-white hover:bg-gray-50 rounded-md font-semibold p-2">
